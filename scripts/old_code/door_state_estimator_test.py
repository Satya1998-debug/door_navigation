...
from door_navigation.scripts.old_code.door_pose_estimator_test import *
...
def estimate_door_state(img_path, depth_path, visualize=True):
    ...
    try:
        ...
        depth_final = get_final_depth(depth_rs, depth_da_corr)
        ...
        roi_depth = crop_to_bbox_depth(depth_final, door_box)
