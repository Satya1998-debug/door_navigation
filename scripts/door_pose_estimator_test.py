...
from utils.depth_calibration import run_depth_anything_v2_on_image, get_corrected_depth_image
from utils.config import IMG_SIZE, CONFIDENCE_THRESHOLD, DETECTION_JSON_PATH, MODEL_PATH, LABEL_MAP
from utils.utils import crop_to_bbox_depth, crop_to_bbox_rgb
from utils.visualization import visualize_plane_with_normal
...
def compute_door_pose_goal(visualize_roi=True, 
    ...
    try:
        ...
        visualize_plane_with_normal(inliers, normal_vector=normal_vector)
